...
class Narrator
{
    ...
    public string Help() =>
        @"Чтобы заработать миллион рублей, необходимо правильно ответить на 15 вопросов.
...
Они останется у игрока даже при неправильном ответе на один из следующих вопросов.
В случае неверного ответа выигрыш участника сокращается до ближайшей достигнутой «несгораемой» суммы, игра заканчивается.
